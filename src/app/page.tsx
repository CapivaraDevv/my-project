    ...
    <div className="bg-black text-gray-100 min-h-screen">
      ...
      <main className="min-h-screen px-6 md:px-16">
        ...
        <section className="flex flex-col items-center justify-center text-center py-24 gap-6">
          ...
          <p className="text-xl max-w-2xl text-gray-300 fadeInUp" style={{ animationDelay: "0.3s" }}>
        ...
        <section className="py-20" id="projetos">
          <h2
            className="text-3xl font-bold text-center mb-12 text-blue-400 fadeInUp glowBlue"
        ...
        <section className="py-20 p-10 rounded-2xl bg-gray-900" id="skills">
          <h2
            className="text-3xl font-bold text-center text-blue-400 fadeInUp glowBlue"
            style={{ animationDelay: "1.3s" }}
          >
            Skills
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-blue-400 font-semibold">
            {["HTML", "CSS", "JavaScript", "TypeScript", "React", "Next.js", "Tailwind", "Vue.js"].map((skill, i) => (
              <div
                key={skill}
        ...
        <section className="py-20 text-center" id="contato">
          ...
          <a
            href="mailto:pedro.h.s.almeida@gmail.com"
